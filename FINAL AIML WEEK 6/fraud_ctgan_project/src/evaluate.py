...
class SyntheticDataEvaluator:
    ...
    def evaluate_ml_performance(self):
        ...
        real_performance = train_and_evaluate(X_train_real, X_test_real, y_train_real, y_test_real)
        ...
        synthetic_performance = train_and_evaluate(X_train_synth, X_test_synth, y_train_synth, y_test_synth)
